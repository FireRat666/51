    ...
    if (e.detail.isLocal && announce === "true") {
      ...
      if(Date.now() - timenow > 5000 && announce === "true") {
        ...
        const moreMessages = [
          ...
          [`https://audiofiles.firer.at/mp3/11-Amelia/Welcome.mp3`, `${theusersname}`, `! The dinosaurs have roared in approval of your arrival!`],
          [`The park's gates are open for `, `${theusersname}`, `! Beware of the T-Rex and enjoy your stay!`],
          [`https://audiofiles.firer.at/mp3/11-Amelia/Welcome.mp3`, `${theusersname}`, `! You've just taken the red pill and entered the chat Matrix!`],
          ...
          [`https://audiofiles.firer.at/mp3/11-Amelia/Welcome.mp3`, `${theusersname}`, `! The stage is set and the spotlight is on you!`],
          [`Strum the guitar and crank up the volume—`, `${theusersname}`, ` is ready to rock!`],
          [`https://audiofiles.firer.at/mp3/11-Amelia/Welcome.mp3`, `${theusersname}`, `! Get ready to dance and sing along in our pop extravaganza!`],
          [`${theusersname}`, ` has just hit the top of the charts in our chat room!`],
          [`https://audiofiles.firer.at/mp3/11-Amelia/Welcome.mp3`, `${theusersname}`, `! Let the smooth jazz tunes and cool conversations begin!`],
          [`${theusersname}`, ` has joined the jazz ensemble! Time to improvise some great conversations!`],
          [`https://audiofiles.firer.at/mp3/11-Amelia/Welcome.mp3`, `${theusersname}`, `! Our chat just became a symphony of ideas with your presence!`],
          [`${theusersname}`, ` has taken the stage—prepare for a classical conversation!`],
          [`https://audiofiles.firer.at/mp3/11-Amelia/Welcome.mp3`, `${theusersname}`, `! You've just walked through the sands of time to our ancient chat!`],
          ...
          [`https://audiofiles.firer.at/mp3/11-Amelia/Welcome.mp3`, `${theusersname}`, `! Zeus and the Olympians are thrilled to have you among us!`],
          ...
          [`https://audiofiles.firer.at/mp3/11-Amelia/Welcome.mp3`, `${theusersname}`, `! The drawing room is abuzz with excitement for your arrival!`],
          [`${theusersname}`, ` has joined our Victorian society! Prepare for refined discussions and tea!`],
          [`https://audiofiles.firer.at/mp3/11-Amelia/Greetings,.mp3`, `${theusersname}`, `! The magical realms welcome you with open arms!`],
          [`The enchanted realm now holds a new hero—welcome,`, `${theusersname}`],
          [`https://audiofiles.firer.at/mp3/11-Amelia/Welcome.mp3`, `${theusersname}`, `! The shadows and mysteries of our realm now embrace you!`],
          ...
          [`https://audiofiles.firer.at/mp3/11-Amelia/Welcome.mp3`, `${theusersname}`, `! The city's magical underbelly just got a bit more interesting!`],
          ...
          [`https://audiofiles.firer.at/mp3/11-Amelia/Welcome.mp3`, `${theusersname}`, `! Platform 9 and 3 quarters is open and ready for your arrival!`],
