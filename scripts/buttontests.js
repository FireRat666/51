async function sdkstuffthing() {
  ...
  async function createObjectTest(thingy1, thingy2) {
    thingy1 = await new BS.GameObject(thingy2).Async();
    return thingy1
  };
  // This Function adds Box geometry to the given game Object
  async function createGeometryTest(thingy1, thingy2) {
    thingy2 = await thingy1.AddComponent(new BS.BanterGeometry(BS.GeometryType.BoxGeometry));
    return thingy2
  };
  ...
  const thistestAudioObject = await new BS.GameObject("MyAudioSource01").Async();
