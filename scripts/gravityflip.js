class GravityFlip {
  ...
  startFlip(rotationAxes, duration, rotations = 1, gravityStrength = 1) {
    if (!this.isFlipping) {
      ...
      this.performFlip(rotationAxes, duration, rotations, gravityStrength); 
    }
  }

  async performFlip(rotationAxes, duration, rotations, gravityStrength) {
...
gravityFlip.startFlip({ x: 0, y: 0, z: -1 }, 1.5, 2, 0.5); // Start a flip with 2 rotations, 1.5 seconds duration, and reduced gravity strength