...
// Create an async function to handle keyboard creation
async function initializeKeyboard() {
    ...
    textTransform.localPosition = new BS.Vector3(8.2, -1.2, 0);
    ...
    async function createKeyboard() {
        const lowercase = "1234567890qwertyuiopasdfghjklzxcvbnm";
        const uppercase = "1234567890QWERTYUIOPASDFGHJKLZXCVBNM";
        ...
        for (let i = 0; i < lowercase.length; i++) {
            ...
            const position = new BS.Vector3(startX + (i % 10) * xOffset, (startY + 0.4) + Math.floor(i / 10) * yOffset, 0);
    ...
    // Initialize the keyboard creation
